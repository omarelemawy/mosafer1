        ...
        child: Stack(
          children: [
            Column(
              ...
              children: [
                BlocProvider(
                  create: (context)=> ComplainRoomCubit()..getComplaintRoomInfo(msaferId: widget.complaint.masafr.id,
                      userId:widget.complaint.user.id,related_chat: widget.complaint.related_chat ),
                                      ...
                                      children: [
                                        ...
                                        ClipOval(
                                          child: FadeInImage.assetNetwork(
                                            ...
                                            image: widget.complaint.user.photo,
