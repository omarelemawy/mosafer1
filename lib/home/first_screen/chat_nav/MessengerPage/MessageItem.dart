...
class MessageItem extends StatelessWidget {
  ...
  const MessageItem(
      {Key key, this.appTheme,this.RequestController, this.isCurrentUser = true, this.message,this.onEnterButtonPress})
      : super(key: key);
  @override
                  ...
                  Row(
                    children: [
                      ...
                      /*ElevatedButton(onPressed: (){
                        onEnterButtonPress();
                      }, child: Text("دخول",style: TextStyle(color: MyTheme.mainAppColor),),style: ButtonStyle(
      ...
      Card(
          ...
          child: Padding(
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                if (message.additionalData.isNotEmpty) Text(
                  message.additionalData["id"],
                  maxLines: 2,
